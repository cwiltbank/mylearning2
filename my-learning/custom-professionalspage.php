<?php /* Template Name: Custom-ProfessionalsPage */ ?>
...
<div class="page-container">
	...
	<div class="section-container">
		<span class="section-title">How can we help you today?</span><br>
		<span class="section-subtext"></span>
	</div>

	<div class="carousel-container">
	<?php echo do_shortcode("[post_grid id='103']"); ?>
	</div>
